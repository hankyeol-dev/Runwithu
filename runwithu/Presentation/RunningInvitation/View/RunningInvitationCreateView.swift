...
final class RunningInvitationCreateView: BaseView, BaseViewProtocol {
   ...
   private let inviteRectangle = RectangleView(backColor: .systemOrange.withAlphaComponent(1.5), radius: 12)
   ...
   let createButton = RoundedButtonView("러닝 초대하기", backColor: .systemOrange.withAlphaComponent(1.5), baseColor: .orange)
